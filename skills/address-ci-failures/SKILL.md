...
Nothing else after that — which bounds your *output*, not the caller's pipeline. When another skill invoked you rather than the user directly, hand control back to it rather than ending the turn.
