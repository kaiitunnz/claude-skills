...
Nothing else after that — which bounds your *output*, not the caller's pipeline. When an orchestrator invoked this skill (`/babysit-prs` does, mid-sweep), hand control back to it rather than ending the turn.
